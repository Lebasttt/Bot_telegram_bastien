"""
Fichier monolithique pour GPT-2 par OpenAI.

Ce script combine TOUS les fichiers Python du dépôt original en un seul
pour une portabilité et une utilisation simplifiées. Il permet de télécharger
les modèles, de générer des échantillons de texte et de lancer une session
interactive.
"""

# ========================================================================================
# Bloc d'imports unifié
# ========================================================================================
import os
import sys
import json
...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Code from src/interactive_conditional_samples.py
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
# ========================================================================================
# Code from src/generate_unconditional_samples.py
# ========================================================================================
...
def generate_unconditional(
    ...
    """
    Generates unconditional samples from the model.
    """
    models_dir = os.path.expanduser(os.path.expandvars(models_dir))
    enc = get_encoder(model_name, models_dir)
    hparams = default_hparams()
...
# ========================================================================================
# Code from download_model.py
# ========================================================================================

def download_model(model_name):
    """
    Downloads the GPT-2 model checkpoints for a given model size.
    """
...
if __name__ == '__main__':
    fire.Fire({
        ...
        'interact': interact,
        'generate': generate_unconditional,
    })
