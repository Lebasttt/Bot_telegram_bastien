...
#================================================================================
# Main execution logic from generate_unconditional_samples.py
#================================================================================
...
def retrieve_knowledge(prompt, knowledge_base_dir='knowledge_base'):
    """
    A simple keyword-based retriever.
    Finds the document in the knowledge base with the most matching keywords from the prompt.
    """
